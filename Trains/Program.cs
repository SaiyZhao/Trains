    ...
    {        
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                IGetMatchRoutes directRoute = RouteFindFactory.CreateRouteControl(FindRouteType.DirectRoute);
                IGetMatchRoutes routeWithMaxStops = RouteFindFactory.CreateRouteControl(FindRouteType.RouteWithMaxStops);
                IGetMatchRoutes routeWithExactlyStops = RouteFindFactory.CreateRouteControl(FindRouteType.RouteWithExactlyStops);
                IGetMatchRoutes lengthOfShortestRoute = RouteFindFactory.CreateRouteControl(FindRouteType.LengthOfShortestRoute);
                IGetMatchRoutes numberOfRoutesLimitDistance = RouteFindFactory.CreateRouteControl(FindRouteType.NumberOfRoutesLimitDistance);
